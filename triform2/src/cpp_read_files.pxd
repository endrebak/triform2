...
cdef extern from "read_files.cpp":
    genome_map read_bed(const char *, uint32_t, uint32_t)
    genome_map read_bed_gz(const char *, uint32_t, uint32_t)
    genome_map read_bedpe(const char *, uint32_t, uint32_t)
    genome_map read_bedpe_gz(const char *, uint32_t, uint32_t)
    genome_map read_bam(const char *, uint32_t, uint32_t)
